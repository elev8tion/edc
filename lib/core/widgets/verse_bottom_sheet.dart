...
class VerseBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: versesAsync.when(
        ...
        data: (verses) => _buildContent(context, verses, parsed),
      ),
    );
  }
  ...
  /// Build main content
  Widget _buildContent(BuildContext context, List<BibleVerse> verses, VerseReference parsed) {
    return Column(
      ...
      children: [
        ...
        // Action buttons
        _buildActionButtons(context, verses, parsed),
      ],
    );
  }
  ...
  Widget _buildActionButtons(BuildContext context, List<BibleVerse> verses, VerseReference parsed) {
      ...
      child: Row(
        children: [
          ...
          _buildIconButton(
            context,
            icon: Icons.share,
            onPressed: () => _shareVerse(targetVerse),
          ),
          const SizedBox(width: 12),
          // Copy button
          _buildIconButton(
